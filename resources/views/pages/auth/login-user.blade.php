            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Selamat datang <span class="font-weight-bold"></span>
                        </h4>
                        <p class="">Di website Pengaduan</p>
                        <form method="POST" action="{{ route('auth.login.cek') }}" class="needs-validation"
                            novalidate="">
                            @csrf
                            ...
                            <div class="form-group text-right">
                                ...
                                {{-- <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg btn-icon icon-right"
                                    tabindex="4">
                                    Login
                                </a> --}}
                            </div>
